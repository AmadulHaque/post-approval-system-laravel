...
@extends('frontend.layouts.app' ,['title' => 'Post Create'])
@section('content')
...
<div class="py-12">
        <div class="container mx-auto px-4 py-8 max-w-4xl">
            <div class="bg-white rounded-xl shadow-md overflow-hidden p-6">
                ...
                <form class="space-y-6" method="POST" action="{{ route('frontend.posts.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="flex items-center justify-between mb-6">
                        ...
                        <div class="flex space-x-2">
                            <button onclick="window.history.back()" class="px-4 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="grid grid-cols-4 gap-3">
                                ...
                                <div class="flex items-center p-2 bg-gray-50 rounded-lg hover:bg-gray-100 transition">
                                    <input id="tag-{{ $tag->id }}" type="checkbox" name="tag_ids[]" value="{{ $tag->id }}"
                    ...
                    <div class="pt-4 border-t border-gray-200 flex justify-end space-x-3">
                        <button onclick="window.history.back()" type="button" class="px-6 py-2 bg-gray-200 text-gray-700 rounded-lg hover:bg-gray-300 transition">
                            <i class="fas fa-times mr-1"></i> Cancel
                        </button>
